...
% Stimuli:
p.categories = {'Animals', 'Colors', 'Countries', ...
                'Distances', 'Metals', 'Relatives'};
p.words = {'Cat'    , 'Sheep'   , 'Chicken' , 'Bird'     , 'Pig'       , 'Dog'  , ...
           'Black'  , 'Cyanogen', 'Green'   , 'Purple'   , 'Gray'      , 'Brown', ...
           'Germany', 'Britain' , 'Thailand', 'Australia', 'Russian'   , 'Italy', ...
           'Mile'   , 'Meter'   , 'Inch'    , 'Kilometer', 'Centimeter', 'Foot' , ...
           'Iron'   , 'Copper'  , 'Aluminum', 'Calcium'  , 'Tin'       , 'Lead' , ...
