    ...
    if strcmp(ext, '.txt')
        ...
        while true
            ...
            if ~ischar(line)
                ...
                if isDataSection
                    [blockName, cycleNo, trialNo, target, response, rt, accuracy] = strread(line, '%s %d %d %d %d %f %c');
                    
                    if strcmp(blockName, 'PlusB')
                        blockNo = 1;
